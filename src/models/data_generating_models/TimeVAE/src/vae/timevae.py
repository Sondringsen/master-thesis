...
from models.data_generating_models.TimeVAE.src.vae.vae_base import BaseVariationalAutoencoder, Sampling
...
class TimeVAE(BaseVariationalAutoencoder):
    ...
    def save(self, model_dir: str):
        ...
        params_file = os.path.join(model_dir, "time_vae_config.pkl")
