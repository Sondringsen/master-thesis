...
from models.data_generating_models.TimeVAE.src.vae.vae_dense_model import VariationalAutoencoderDense as VAE_Dense
from models.data_generating_models.TimeVAE.src.vae.vae_conv_model import VariationalAutoencoderConv as VAE_Conv
